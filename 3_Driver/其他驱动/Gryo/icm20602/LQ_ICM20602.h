...
#define IMU963RA_SPI                                LPSPI3     // 硬件 SPI3 
//#define IMU963RA_SPC_PIN                            (SPI3_SCK )     // 硬件 SPI SCK 引脚
//#define IMU963RA_SDI_PIN                            (SPI3_SDI)     // 硬件 SPI MOSI 引脚
//#define IMU963RA_SDO_PIN                            (SPI3_SDO)     // 硬件 SPI MISO 引脚
//#define IMU963RA_CS_PIN                             (SPI3_CS0)      // 硬件 CS 片选引脚
//====================================================硬件 SPI 驱动====================================================
#endif
...
extern short imu963ra_mag_x,  imu963ra_mag_y,  imu963ra_mag_z;

void imu963ra_get_acc (void);
void imu963ra_get_gyro (void);
void imu963ra_get_mag (void);

u8 imu963ra_init (void);
