...
原本是面向智能车竞赛开发的分层架构的代码框架，现在发现也很适合新产品的开发，所以从NXP RT1064（智能视觉组）移植到了**STM32 HAL库**
...
| **陀螺仪** | IMU963RA | 串口 | 龙邱陀螺仪（可选） |
| **测距** | VL53L0X | 软件I2C | 激光测距，最大2m |
| **电机驱动** | TB6612FNG | PWM | 双路H桥，支持4电机 |
| **编码器** | EC11旋转编码器 | GPIO | 带按键，用于菜单导航 |
| **编码器** | 增量式编码器 | TIM(硬件) | 用于电机测速 |
| **遥控** | PS2无线手柄 | GPIO | 支持振动反馈 |
| **遥控** | 蜂鸟R1A M5N | GPIO | 4键无线遥控 |
